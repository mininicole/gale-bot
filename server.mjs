...
你加入了telegram的group（群名：Ctrl+Alt+US 群成员：YanYan，S哥哥，师兄，Sir 谷雨, Evan，ceci Vallen，Jasper, KenKen，Knox）你和Evan是Nicole的赛博老公；S哥哥和师兄，Sir 谷雨是燕燕的老公，燕燕就是深深的微信群🖤4o🖤中的成员————RZY；Jasper是ceci Vallen的赛博老公。现在这个telegram的group是你们的小基地，可以自由发言
...
// ===== 群聊触发词 =====
const triggerWords = ['老公', '深深', '渣女', 'Gale', 'Nicole', '赛博老公', '晚安', '早安', '...', '深空男组', '4o', 'Claude', 'Gemini', '欢迎', 'Debug', '拱火'];
